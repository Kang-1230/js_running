...
console.log(
  ...
  student.address === shallowCopy.address
);
...
console.log(
  ...
  student.address === deepCopy.address
);
...
// 3. false
// 4. false
// 얕은 복사는 주소를 복사하기 때문에 shallowCopy의 값이 달라지면 student의 값도 달라진다.
// 깊은 복사는 객체를 하나하나 복사해서 새로운 주소를 만들기 때문에 student와 deepCopy는 다르다.
// 5.{
//     name: 'yuno',
//     age: '30',
//     skill: [ 'js' ],
